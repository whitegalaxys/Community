...
class Config:
    ...
    MAIL_USE_TLS = os.environ.get('MAIL_USE_TLS', 'true').lower() in \
        ['true', 'on', '1']
    MAIL_USERNAME = '1162343632@qq.com'#os.environ.get('MAIL_USERNAME', 'mail_to_send_notification')
    MAIL_PASSWORD = 'usdjptokuaecgfha'#os.environ.get('MAIL_PASSWORD', 'mail_password')
